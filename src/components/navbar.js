...
import { AngelList, Facebook, Hamburger, LinkedIn, Twitter, Whatsapp } from './common/icons';
...
const Navbar = () => {
  ...
  return (
    <nav className=" fixed z-50 w-full flex flex-wrap items-center justify-between py-4 bg-gray-100 text-gray-500 hover:text-gray-700 focus:text-gray-700 shadow-lg navbar navbar-expand-lg navbar-light">
      {dashboard && (
        <Dashboard
          sx={
            ...
            >
              ...
              <li>
                <a
                  ...
                  href="https://www.linkedin.com/in/makoji-david"
                  rel="norefferer"
                  target={"_blank"}
                >
                  LinkedIn
              ...
              <li>
                <a
                  className="dropdown-item text-sm py-2 px-2 font-normal block w-full whitespace-nowrap bg-transparent text-gray-70 hover:bg-gray-100 relative"
                  href="https://angel.co/u/omakoji-david"
                  rel="norefferer"
                  target={"_blank"}
                >
                  Angellist
